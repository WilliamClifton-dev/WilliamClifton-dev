...
- **[HBTI Coach](https://github.com/WilliamClifton-dev/java-ai-langchain4j)** —— Spring Boot + LangChain4j 体重管理 AI 教练后端原型。把 AI 系统拆成"确定性服务 + 6 个服务器授权工具 + LLM 对话"三层架构；16 个 ADR；后端、前端质量门禁与 Compose runtime smoke 均通过。
